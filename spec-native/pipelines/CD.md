...
- **Paquetes:** `@rafex/galaxia-fhs-protocol` (`packages/fhs-protocol`), `@rafex/galaxia-atlas`, `@rafex/galaxia-navigator`, `@rafex/galaxia-portal-chat` — esos son los nombres en GitHub Packages; en npmjs.org los mismos paquetes se publican como `@rafex_labs/galaxia-*` (DEC-0071).
...
| Core (Atlas/Navigator/Portal) | N/A | No — despliegue manual (`just container-up`/`podman-compose`, o `npx @rafex/galaxia-atlas`/`@rafex/galaxia-navigator`/`@rafex/galaxia-portal-chat`) contra el bastion/laptop del operador | No aplica, es despliegue manual |
