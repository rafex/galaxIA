...
export type AgentSSEEvent = SessionEvent | AgentStatusEvent | LlmSelectedEvent | LlmStreamingEvent | ToolSelectedEvent | ToolRunningEvent | ToolCompletedEvent | ToolErrorEvent | AssistantDeltaEvent | AssistantCompletedEvent | OcrExtractedEvent | NodeLostEvent | NodeOnlineEvent | KbRecommendedEvent | KbWarningEvent | ErrorEvent;
