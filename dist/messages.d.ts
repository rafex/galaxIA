...
export type RegistryOutboundMessage = WelcomeMessage | RegisteredMessage | PongMessage | NodeOnlineMessage | NodeLostMessage | RegistryErrorMessage | NodeUpdatedMessage;
export type RegistryInboundMessage = HelloMessage | RegisterMessage | PingMessage;
...
export type LlmProviderOutboundMessage = ChatDeltaMessage | ChatCompletedMessage | ChatErrorMessage | DispatchAckMessage;
export type LlmProviderMessage = LlmProviderInboundMessage | LlmProviderOutboundMessage;
...
export type ToolProviderInboundMessage = ToolCallRequestMessage | ToolListRequestMessage;
export type ToolProviderOutboundMessage = ToolCallResultMessage | ToolCallErrorMessage | ToolListResponseMessage | DispatchAckMessage;
export type ToolProviderMessage = ToolProviderInboundMessage | ToolProviderOutboundMessage;
