...
export function base58Decode(str) {
    ...
    for (const char of str) {
        ...
        if (index < 0)
            throw new Error(`Carácter base58 inválido: ${char}`);
...
export function didToPublicKeyRaw(did) {
...
function rawPublicKeyToKeyObject(rawPublicKey) {
...
export function loadIdentity(privateKeyPem) {
 ...
 */
export function verifySignature(did, payload, signatureBase64) {
    try {
